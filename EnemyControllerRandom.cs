...
namespace Unity.FPS.AI
{
    ...
    public class EnemyControllerRandom : MonoBehaviour
    {
        ...
        EnemyManagerRandom m_EnemyManager;
        ...
        void Start()
        {
            m_EnemyManager = FindObjectOfType<EnemyManagerRandom>();
            DebugUtility.HandleErrorIfNullFindObject<EnemyManager, EnemyControllerRandom>(m_EnemyManager, this);

            m_ActorsManager = FindObjectOfType<ActorsManager>();
            DebugUtility.HandleErrorIfNullFindObject<ActorsManager, EnemyControllerRandom>(m_ActorsManager, this);

            m_EnemyManager.RegisterEnemy(this);

            m_Health = GetComponent<Health>();
            DebugUtility.HandleErrorIfNullGetComponent<Health, EnemyControllerRandom>(m_Health, this, gameObject);

            m_Actor = GetComponent<Actor>();
            DebugUtility.HandleErrorIfNullGetComponent<Actor, EnemyControllerRandom>(m_Actor, this, gameObject);

            NavMeshAgent = GetComponent<NavMeshAgent>();
            m_SelfColliders = GetComponentsInChildren<Collider>();

            m_GameFlowManager = FindObjectOfType<GameFlowManager>();
            DebugUtility.HandleErrorIfNullFindObject<GameFlowManager, EnemyControllerRandom>(m_GameFlowManager, this);
            ...
            DebugUtility.HandleErrorIfNoComponentFound<DetectionModule, EnemyControllerRandom>(detectionModules.Length, this,
                gameObject);
            DebugUtility.HandleWarningIfDuplicateObjects<DetectionModule, EnemyControllerRandom>(detectionModules.Length,
                this, gameObject);
            Debug.Log(string.Format("Detection Module Total {0}", detectionModules.Length));
        ...
        void OnDamaged(float damage, GameObject damageSource)
        {
            ...
            if (damageSource && !damageSource.GetComponent<EnemyControllerRandom>())
            {
                // pursue the player
        ...
        void FindAndInitializeAllWeapons()
        {
            ...
            if (m_Weapons == null)
            {
                ...
                DebugUtility.HandleErrorIfNoComponentFound<WeaponController, EnemyControllerRandom>(m_Weapons.Length, this,
                    gameObject);
        ...
        public WeaponController GetCurrentWeapon()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<WeaponController, EnemyControllerRandom>(m_CurrentWeapon, this,
                gameObject);
