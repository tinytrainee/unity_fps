...
namespace Unity.FPS.AI
{
    ...
    public class EnemyTurretRandom : MonoBehaviour
    {
        public enum AIState
        {
            Idle,
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<Health, EnemyTurretRandom>(m_Health, this, gameObject);
            m_Health.OnDamaged += OnDamaged;

            m_EnemyController = GetComponent<EnemyControllerRandom>();
            DebugUtility.HandleErrorIfNullGetComponent<EnemyControllerRandom, EnemyTurretRandom>(m_EnemyController, this,
                gameObject);
